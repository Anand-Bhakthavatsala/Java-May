...
public class Hello1 {
	...
	//	String st3=st1.//camel notation followed in Java
		...
		//Converting whole string In upper case. 
		 ...
		 int j = 75;   String val2 = String.valueOf(j);   
		 System.out.println("Value Of string val2 Is -> "+val2); 
		// String k = j+val2;
		//Converting from string to integer, use the method paseInt()
		 int k = Integer.parseInt(val2);
		 System.out.println("Value of k "+ (j+k));
		 //Converting string to integer.   
		 String val1="50";   
		 int i = Integer.parseInt(val1);   
		 System.out.println("Value Of int i Is -> "+i);      
		 //Print the String starting from 5th Index to 10th Index.   
		 System.out.println("Retrieving sub string from string -> "+st1.substring(5, 10));      
		 //Split string.    
